  ...
  return (
    <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24'> 
        <div className='text-center'>
            <h1 className='text-4xl sm:text-6xl font-bold bg-gradient-to-r from-purple-300 via-purple-400 to-pink-500 bg-clip-text text-transparent drop-shadow-2xl'>
                Build powerful workflows incredibly fast
            </h1>
            <p className='mt-8 text-lg sm:text-xl text-neutral-300 max-w-3xl mx-auto leading-relaxed'>
