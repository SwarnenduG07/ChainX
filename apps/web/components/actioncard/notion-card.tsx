...
const handleconnection = async () => {
  try {
    ...
    if (!token) throw new Error("No token found"); 
     const res = await axios.post(`${BACKEND_URL}/api/v1/action/notion/auth`, {
    ...
    alert("Cant COnnect to notion");
    
  }
}

const NotionSelection = ({ setMetadata, onClose }: { setMetadata: (params: any) => void, onClose?: () => void }) => {
...
export default NotionSelection;